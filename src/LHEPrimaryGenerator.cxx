...
LHEPrimaryGenerator::LHEPrimaryGenerator(std::string name, LHEReader* theReader) :
        PrimaryGenerator(name), reader_(theReader) {
}
            ...
            if (particle->getISTUP() > 0) {
                ...
                if (particle->getIDUP() == -623) { /* Tungsten ion */
                    ...
                    if (tungstenIonDef != NULL) {
                        ...
                        G4Exception("LHEPrimaryGenerator::GeneratePrimaryVertex", "EventGenerationError",
                                FatalException, "Failed to find particle definition for W ion.");
                    }
                } else {
